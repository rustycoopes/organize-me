...
def register_chrome(env: Environment, app_service_name: str) -> None:
    ...
    env.globals["TABLE_BODY_ROW_ZEBRA_CLASSES"] = TABLE_BODY_ROW_ZEBRA_CLASSES
    env.globals["TABLE_BODY_CELL_CLASSES"] = TABLE_BODY_CELL_CLASSES
    env.globals["PAGE_HEADER_WRAP_CLASSES"] = PAGE_HEADER_WRAP_CLASSES
    env.globals["PAGE_HEADER_TEXT_CLASSES"] = PAGE_HEADER_TEXT_CLASSES
